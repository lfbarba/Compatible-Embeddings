...
and let $P$ be the shortest hamiltonian path of $X$, i.e., the shortest
...
\subsection{Preliminaries}\label{section:Preliminaries} Let $C$ be a connected geometric plane graph. Let $v_0, v_1, \ldots, v_k, v_0$ be the sequence of vertices of $C$ visited by a counterclockwise
...
vertex set is the set of corners of $C$.
