...
augmentation with the fewest number of vertices.  This motivates the
...
Let $C$ be a connected geometric planar graph. 
...
An element $v_i$ in this sequence is called a \emph{corner} of $C$.  
