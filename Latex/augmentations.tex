...
deformation. This morphing problem has been studied extensively~\cite{cairns:deformations,alamdari.angelini.ea:morphing,angelini.dalozzo.ea:morphing,grunbaum.shephard:geometry,thomassen:deformations}.

Most morphing algorithms require that the input graph,
$\mathcal{G}$, be connected. In many applications of morphing (for example
in Figure~\ref{fig:faces}) the input graph is not connected. To apply this algorithms
...
\begin{figure}
  ...
  \caption{\small Compatible triangulations of two 4-gons $P$ and~$Q$.}
...
Intuitively, a corner is a copy of a vertex of the
