...
Let $a_1, \ldots, a_r$ be an arbitrary order of the attachment corners of $G$ (we can relabel the components to obtain an incremental order of the labels). 
...
$C_1,\ldots,C_t$ ($t\leq r$), we can use (a small modification of)
