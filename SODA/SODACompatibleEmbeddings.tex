...
$\mathcal{G}$. We wish to extend $\mathcal G$ by adding  vertices and edges to make
it connected and in such a way that these vertices and edges can be added to $G_1,\ldots,G_k$ to obtain planar drawings isomorphic to the extension of $G$.  We show that
...
A \emph{drawing} of a graph $\mathcal{G}=(V,E)$
